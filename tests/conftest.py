...
from tests.fixtures.operational_info import *  # noqa isort:skip
...
check_redis_url(
    config.CELERY_BROKER_REDIS_URL_AUTHORIZATION_ANDROID,
    "CELERY_BROKER_REDIS_URL_AUTHORIZATION_ANDROID",
)
check_redis_url(
    config.CELERY_BROKER_REDIS_URL_AUTHORIZATION_IOS, "CELERY_BROKER_REDIS_URL_AUTHORIZATION_IOS"
)
